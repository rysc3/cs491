...
srun --mpi=pmi2 singularity run --nv -B $TMP_WORKING_DIR:/my-dat-files /users/rdscher/CLASS/cs491/HPCG/hpc-benchmarks:24.03.sif /users/rdscher/CLASS/cs491/HPCG/hpcg.sh --dat /my-dat-files/hpcg.dat >> hpcg.out
echo xhpcg finished
