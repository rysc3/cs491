...
int main( int argc, char** argv )
{
  ...
  // Check input size. Atoi returns 0 if it doesn't understand the input string. Zero is also an invalid matrix size.
  if ( r1 == 0 || r2 == 0 )
    {
      printf("Usage: %s {Arows} {Acols} {Brows} {Bcols}\n", argv[0]);
      printf("Invalid numer of rows".);
      return 3
    }
  ...
  if ( c1 == 0 || c2 == 0 )
    {
      printf("Usage: %s {Arows} {Acols} {Brows} {Bcols}\n", argv[0]);
      printf("Invalid numer of columns.");
      return 3
    }
